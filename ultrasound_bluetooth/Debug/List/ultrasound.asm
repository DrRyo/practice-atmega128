...
_0x0:
	.DB  0x4F,0x62,0x6A,0x65,0x63,0x74,0x20,0x69
	.DB  0x73,0x20,0x25,0x64,0x20,0x63,0x6D,0x20
	.DB  0x66,0x61,0x72,0x20,0x66,0x72,0x6F,0x6D
	.DB  0x20,0x73,0x65,0x6E,0x73,0x6F,0x72,0x2E
	.DB  0xD,0xA,0x0
__RESET:
	CLI
	CLR  R30
...
; 0000 002B     pulse_count++;      // Increase at every 58us
	LDI  R26,LOW(_pulse_count)
	LDI  R27,HIGH(_pulse_count)
	RCALL SUBOPT_0x0
; 0000 002C }
	LD   R30,Y+
	OUT  SREG,R30
...
; 0000 0032         pulse_count = 0;
	LDI  R30,LOW(0)
	STS  _pulse_count,R30
	STS  _pulse_count+1,R30
...
; 0000 003C         printf("Object is %d cm far from sensor.\r\n", pulse_count);
	...
	ST   -Y,R31
	ST   -Y,R30
	LDS  R30,_pulse_count
	LDS  R31,_pulse_count+1
	CLR  R22
	CLR  R23
	RCALL __PUTPARD1
	LDI  R24,4
