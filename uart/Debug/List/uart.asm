...
_TX0_ch:
; .FSTART _TX0_ch
; 0000 0024     while(!(UCSR0A&(1<<UDRE0)));
	ST   -Y,R17
	MOV  R17,R26
;	data -> R17
_0x3:
...
_main:
; .FSTART _main
; 0000 0029     PORTG = 0x01;
	LDI  R30,LOW(1)
	STS  101,R30
; 0000 002A     DDRG = 0x03;
	LDI  R30,LOW(3)
	STS  100,R30
; 0000 002B     uart0_init();
	RCALL _uart0_init
; 0000 002C 
; 0000 002D     while(1){
_0x6:
...
; 0000 0030         //printf("ABC");
; 0000 0031         //printf("ABC");
; 0000 0032         PORTG ^= 0x03;
	LDS  R30,101
	LDI  R26,LOW(3)
	EOR  R30,R26
	STS  101,R30
; 0000 0033         delay_ms(PORTG * 1000);
	LDS  R30,101
	LDI  R31,0
	LDI  R26,LOW(1000)
	LDI  R27,HIGH(1000)
